...
const Card = () => {
  return (
    <div className='bg-white shadow-custom-dark  border-2 border-black flex flex-col justify-center items-center w-[90%] max-w-80 md:max-w-[21rem] py-5 px-4 rounded-xl'>
      <div className=''>
        <img
